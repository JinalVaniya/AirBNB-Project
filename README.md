...
Project Overview
In this comprehensive data science project, you will step into the role of a data analyst working for two competing investment firms seeking to expand their short-term rental portfolios from New York City to Jersey City. Using real Airbnb listing data, you'll explore the critical distinction between sound statistical modeling practices and the dangerous pitfalls of overfitting—while discovering that even rigorous methodology faces challenges in cross-market deployment.
